...
color_palette <- c("Other (< 2%)" = "#837b8d", #"Bradyrhizobium sp. BTAi1" = "#ce3d32",
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_species.png",
  species,
  width = 8.5,
  height = 4,
  dpi = 600
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_genus.png",
  genus,
  width = 8.5,
  height = 4,
  dpi = 600
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_family.png",
  family,
  width = 8.5,
  height = 4,
  dpi = 600
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_order.png",
  order,
  width = 8.5,
  height = 4,
  dpi = 600
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_class.png",
  class,
  width = 8.5,
  height = 4,
  dpi = 600
...
# Save the plot
ggsave(
  "images/bar_plots/bar_plot_phylum.png",
  phylum,
  width = 8.5,
  height = 4,
  dpi = 600
...
ggsave(
  "images/bar_plots/bar_plot_everything.png",
  plot = everything,
  width = 20,
  height = 8,
  dpi = 600
...
ggsave(
  "images/bar_plots/bar_plot_combined.png",
  plot = combined,
  width = 20,
  height = 4,
  dpi = 600
